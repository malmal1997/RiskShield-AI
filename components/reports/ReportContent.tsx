    ...
    <div className="p-8 bg-white font-sans text-gray-800">
      ...
      <div className="mb-10" style={{ pageBreakBefore: 'always' }}>
        ...
        {currentCategory.questions.map((question, index) => {
          ...
          return (
            <div key={question.id} className="mb-8 p-6 border border-gray-200 rounded-lg shadow-sm" style={{ pageBreakInside: 'avoid', pageBreakBefore: 'auto', pageBreakAfter: 'auto' }}>
      ...
      <div className="mt-10 p-6 bg-yellow-50 border border-yellow-200 rounded-lg text-center" style={{ pageBreakBefore: 'always', pageBreakInside: 'avoid' }}>
        ...
        <p className="text-yellow-700 text-base">
          ...
          RiskShield AI may make mistakes. Please use with discretion and verify results with internal expertise.
        </p>
      </div>
      ...
      <div className="mt-10 pt-8 border-t border-gray-200 text-center text-gray-600 text-sm" style={{ pageBreakBefore: 'always', pageBreakInside: 'avoid' }}>
        <p>Report generated by RiskShield AI - AI-Powered Risk Assessment Platform</p>
        <p>
          Assessment ID: {aiAnalysisResult.assessmentId || `${aiAnalysisResult.analysisDate.split("T")[0]}-${Math.random().toString(36).substr(2, 9)}`} •
