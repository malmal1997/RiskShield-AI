        ...
        {currentCategory.questions.map((question, index) => {
          ...
          return (
            <div key={question.id} className="mb-8 p-6 border border-gray-200 rounded-lg shadow-sm" style={{ pageBreakInside: 'avoid', pageBreakBefore: 'auto' }}>
              ...
              <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg" style={{ pageBreakInside: 'avoid', pageBreakAfter: 'avoid', pageBreakBefore: 'auto' }}>
              ...
              <div className="mb-4 p-4 bg-gray-50 border border-gray-200 rounded-lg" style={{ pageBreakInside: 'avoid', pageBreakAfter: 'avoid', pageBreakBefore: 'auto' }}>
                <p className="text-sm font-medium text-gray-800 mb-2">Reasoning:</p>
                <p className="text-gray-700">{reasoning}</p>
              </div>

              {excerpts.length > 0 && (
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg" style={{ pageBreakInside: 'avoid', pageBreakAfter: 'avoid', pageBreakBefore: 'auto' }}>
