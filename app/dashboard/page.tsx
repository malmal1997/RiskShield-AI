...
function DashboardContent() {
  ...
  const { user, organization, loading: authLoading, hasPermission } = useAuth()
      ...
      <section className="py-12 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {hasPermission("view_assessments") && (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-gray-900">{riskMetrics.totalAssessments - riskMetrics.completedAssessments}</p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-gray-900">{riskMetrics.highRiskVendors}</p>
                    </div>
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            <TabsList className="grid w-full grid-cols-5">
              ...
              {hasPermission("view_vendors") && <TabsTrigger value="vendors">Vendors</TabsTrigger>}
              {hasPermission("view_dashboard") && <TabsTrigger value="compliance">Compliance</TabsTrigger>}
              {hasPermission("view_reports") && <TabsTrigger value="risk-reports">Risk Reports</TabsTrigger>}
            </TabsList>
